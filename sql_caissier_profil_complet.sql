-- Ajout des champs de profil complet (comme chauffeur) + photo sur utilisateur
ALTER TABLE utilisateur
  ADD COLUMN IF NOT EXISTS Email VARCHAR(100) NULL AFTER Telephone,
  ADD COLUMN IF NOT EXISTS Date_Naissance DATE NULL AFTER Email,
  ADD COLUMN IF NOT EXISTS Lieu_Naissance VARCHAR(150) NULL AFTER Date_Naissance,
  ADD COLUMN IF NOT EXISTS Nationalite VARCHAR(50) NULL AFTER Lieu_Naissance,
  ADD COLUMN IF NOT EXISTS Profession VARCHAR(100) NULL AFTER Nationalite,
  ADD COLUMN IF NOT EXISTS Type_Piece VARCHAR(50) NULL AFTER Profession,
  ADD COLUMN IF NOT EXISTS Numero_Piece VARCHAR(100) NULL AFTER Type_Piece,
  ADD COLUMN IF NOT EXISTS Date_Delivrance DATE NULL AFTER Numero_Piece,
  ADD COLUMN IF NOT EXISTS Lieu_Delivrance VARCHAR(150) NULL AFTER Date_Delivrance,
  ADD COLUMN IF NOT EXISTS Date_Expiration DATE NULL AFTER Lieu_Delivrance,
  ADD COLUMN IF NOT EXISTS Photo BLOB NULL AFTER Date_Expiration;
...
BEGIN
    SELECT u.Id_Utilisateur, u.Nom, u.Prenom, u.Sexe, u.Telephone, u.Email,
           ...
           u.Type_Piece, u.Numero_Piece, u.Date_Delivrance, u.Lieu_Delivrance, u.Date_Expiration,
...
BEGIN
    INSERT INTO utilisateur (Nom, Prenom, Sexe, Telephone, Email, Date_Naissance, Lieu_Naissance,
                              ...
                              Lieu_Delivrance, Date_Expiration, Photo,
    ...
    VALUES (p_nom, p_prenom, p_sexe, p_telephone, p_email, p_date_naissance, p_lieu_naissance,
            ...
            p_lieu_delivrance, p_date_expiration, p_photo,
